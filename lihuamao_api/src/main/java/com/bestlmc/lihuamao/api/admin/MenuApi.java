...
public class MenuApi {
    ...
    public CommonResult getExpandPageList(@RequestBody MenuVO menuVO){

        return new CommonResult(APIRquest.REQUEST_SUCCESS, MessageConf.OPERATION_SUCCESS, iTMenuService.getExpandPageList(menuVO));
    }
